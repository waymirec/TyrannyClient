...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterMovementController:SuperStateMachine
    {
        ...
        protected override void LateGlobalSuperUpdate()
        {
            ...
            movePacket.Write(Guid.NewGuid().ToByteArray());
            movePacket.Write(transform.position.x);
            movePacket.Write(transform.position.y);
            movePacket.Write(transform.position.z);
            Debug.Log("Calling NetworkManager.Send");
